...
class Kick_It_Out_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<div class="widget-inner clearfix">
			<div class="user-avatar"><img alt="" src="<?php echo esc_url( POETS_WIDGETS_URL . 'assets/images/kio-truce.jpg' ); ?>" class="avatar avatar-100 photo" height="100" width="100"></div>
			<div class="user-links">
				<ul>
					<li class="poems-link"><a href="<?php echo esc_url( get_permalink( 22977 ) ); ?>"><?php esc_html_e( 'Your Kick It Out Poems', 'poets-widgets' ); ?></a></li>
					<li class="poems-link"><a href="<?php echo esc_url( get_permalink( 22979 ) ); ?>"><?php esc_html_e( 'Your Christmas Truce Poems', 'poets-widgets' ); ?></a></li>
					<li class="poems-link"><a href="<?php echo esc_url( get_permalink( 22981 ) ); ?>"><?php esc_html_e( 'Your Football At Christmas Poems', 'poets-widgets' ); ?></a></li>
				</ul>
			</div>
		</div>
		<?php
