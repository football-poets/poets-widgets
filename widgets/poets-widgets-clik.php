<?php
/**
 * Football Poets "Clik Here" Widget.
 *
...
/**
 * "Clik Here" Widget class.
 *
 * @since 0.1
 */
class Clik_Here_Widget extends WP_Widget {
	 ...
	 * @since 0.1
	 * @access public
	 * @var object $cpt The WordPress user ID for Clik Here
	 */
	public $user_id = 4;
	...
	public function __construct() {
		...
		// Define args.
		$args = [
			'description' => __( 'Use this widget to show the "Clik Here" widget.', 'poets-widgets' ),
			'classname'   => 'widget widget_fp_clik_widget clearfix',
		];

		// Init parent.
		parent::__construct(
			'fp_clik_widget', // Base ID.
			__( 'Clik Here', 'poets-widgets' ), // Name.
			$args
		);
	...
	public function form( $instance ) {
		...
		if ( isset( $instance['title'] ) ) {
			...
			$title = __( 'Clik Here', 'poets-widgets' );
		}
...
register_widget( 'Clik_Here_Widget' );
