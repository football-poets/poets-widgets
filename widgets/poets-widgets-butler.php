		...
		if ( $user->exists() ) :
			...
			<div class="widget-inner clearfix">
				...
				<div class="user-links">
					<ul>
						<li class="poems-link"><a href="<?php echo get_permalink( 85 ); ?>"><?php echo __( 'Poems &amp; Profile', 'poets-widgets' ); ?></a></li>
						<li class="news-link"><a href="<?php echo esc_url( get_category_link( 20 ) ); ?>"><?php echo __( 'Blog Posts', 'poets-widgets' ); ?></a></li>
					</ul>
				</div>
			</div>
			<?php
